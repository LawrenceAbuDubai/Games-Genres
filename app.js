...
alert("hey!! , wlecome to my website " + userName );
...
var moreInfo = prompt("do you want to learn more about any genre? y / n")
if(moreInfo == "y"){
  showMoreInfo();
}
...
var putImg = Number(prompt("how many times do you want to see this image?"));

for (let j = 0; j < putImg; j++) {
  if(favGenre == "sports"){
    document.write(
      "<div>" + "<h3>" + favGenre+"</h3>"
    + "<img  src='https://e7.pngegg.com/pngimages/549/880/png-clipart-lewiston-event-center-sport-flight-simulator-simulation-multi-sports-game-text-thumbnail.png' width='100' height='100'     />" + "</div>")
